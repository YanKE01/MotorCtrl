...
#define LD                              (0.000165*1.0)                ///< (H) D轴电感
#define LQ                              (0.000165*1.0)                ///< (H) Q轴电感
#define RS                             	(0.4*1.0)                   ///< (Ω) 相电阻
#define Ke                              (7*1.0)	              ///< (V/KRPM)反电动势常数
...
/* -----切环之后的电流环KPKI设置值----- */
#define DQKP                           _Q12(1.0)                      ///< 切到闭环后DQ轴KP 
#define DQKI                           _Q15(0.02)                     ///< 切到闭环后DQ轴KI  
...
/* -----电流控制模式下速度曲线的最大最小值----- */
#define MOTOR_SPEED_MAX_RPM            (6000.0)                      ///< (RPM) 运行最大转速 90000
