...
MODEL                   = pmsm_foc
MODULES                 = rt_logging_simtarget.c pmsm_foc.c pmsm_foc_capi.c pmsm_foc_data.c pmsm_foc_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = pmsm_foc.exe
MAKEFILE                = pmsm_foc.mk
MATLAB_ROOT             = D:\software\Matlab
ALT_MATLAB_ROOT         = D:\software\Matlab
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = pmsm_foc_ref.rsp
COMPILER_COMMAND_FILE     = pmsm_foc_comp.rsp
