...
void US_vSysErrorCheck(void)
{
	...
	s16temp = (_IQ15mpyIQ15(UG_sCurrentAll.sCurrentAlphaBeta.s16Alpha, UG_sCurrentAll.sCurrentAlphaBeta.s16Alpha) \
					 + _IQ15mpyIQ15(UG_sCurrentAll.sCurrentAlphaBeta.s16Beta, UG_sCurrentAll.sCurrentAlphaBeta.s16Beta))>>6;
