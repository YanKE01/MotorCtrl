...
* File Name          : IQmathLib.h
* Author             : LX Motor Lab  
* Date  						 : 2021-12-16
* Description        : IQ math Lib file
*******************************************************************************/
...
#define    __IQmpy(A,B,GLOBAL_Q)  ((((long long)A*(long long)B))>>GLOBAL_Q)
...
//--------------------------------------------------------------------------
#define   __IQ15mpyIQ12(A,B)  ((((long)A*B))>>15)
#define   _IQ15mpyIQ12(A,B)    		__IQ15mpyIQ12(A,B)

#define   __IQ14mpyIQ12(A,B)  ((((long)A*B))>>14)
#define   _IQ14mpyIQ12(A,B)    		__IQ14mpyIQ12(A,B)

#define   __IQ15mpyIQ15(A,B)  ((((long)A*B))>>15)
#define   _IQ15mpyIQ15(A,B)    __IQ15mpyIQ15(A,B)

#define   __IQ12mpyIQ12(A,B)  ((((long)A*B))>>12)
#define   _IQ12mpyIQ12(A,B)    __IQ12mpyIQ12(A,B)
//---------------------------------------------------------------------------
...
#if NEW_VERSION_FPGA
	#define   _IQ24div(A,B)		DIV_IQ_MACRO(A,B)
#else
	#define   _IQ24div(A,B)   DIV_IQ_MACRO(A,B)
#endif
#if GLOBAL_Q == 30
