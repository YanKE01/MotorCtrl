...
void TIM3_CFG_CH1()
{
  ...
  TIM3_IntputSourceCfg(TIM3_INPUT_TI1, TIM3_IntputSource_TIM16_OC1_TRIG); // 配置捕获源：TIM3 TI1捕获TIM1_OC16_TRIG
...
int main()
{
  ...
  RCC_APB0PeriphClockCmd(RCC_APB0Periph_TIM16, ENABLE);
