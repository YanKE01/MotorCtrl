...
void TIM17_CFG_CH1()
{
	...
	TIM17_IntputSourceCfg(TIM17_INPUT_TI1, TIM17_IntputSource_ACMP0_OUTPUT); // 配置捕获源：TIM17 TI1捕获ACMP0_OUTPUT
...
int main()
{
	...
	acmp0_cfg(); // PA0(OUT) PA1(P) DAC0(N)
