...
#define SSP0_SIZE 8UL
#define SSP0_DR_Address (0x40018008)
...
void SSP0_Master_Cfg(void)
{
	...
	DMA_InitStructure.DMA_PeripheralBaseAddr = SSP0_DR_Address;				//用来设置DMA传输的外设基地址
	...
	DMA_InitStructure.DMA_BufferSize = SSP0_SIZE;							//设置一次传输数据量的大小
	...
	DMA_RemapConfig(DMA1_Channel2, DMA_ReqNum0, DMA_REQ_SSP0_TX); /// DMA请求号映射到外设
