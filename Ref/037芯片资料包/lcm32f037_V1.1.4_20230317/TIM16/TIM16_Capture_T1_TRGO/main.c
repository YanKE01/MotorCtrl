...
static void tim1_cfg_init()
{
  ...
  TIM_SelectOutputTrigger(TIM1, TIM_TRGOSource_OC1Ref); //选择TRGO输出触发源
...
void TIM16_CFG_CH1()
{
  ...
  TIM16_IntputSourceCfg(TIM16_INPUT_TI1, TIM16_IntputSource_TIM1_TRGO); // 配置捕获源：TIM16 TI1捕获TIM1_TRGO
