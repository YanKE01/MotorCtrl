...
/***********
TIM1的PWM输出，带死区、带刹车
死区需要配置TIM_ClockDivision（死区时钟分频）TIM_DeadTime（死区时间宽度）
********************************************************************************8*/
...
static void tim1_cfg_init()
{
	...
	TIM_TimeBaseStructure.TIM_ClockDivision = TIM_CR1_CKD_0; //死区和滤波时钟分频CKD
